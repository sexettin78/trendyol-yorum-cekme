...
import time
dosya = open("kotuyorumlar.txt", "a", encoding='utf-8')
...
time.sleep(3)
driver.find_element_by_xpath("/html/body/div[1]/div[3]/div/div/div/div/div[1]/div/div[6]/div[2]/div[1]/span").click()
time.sleep(3)
driver.find_element_by_xpath("/html/body/div[1]/div[3]/div/div/div/div/div[1]/div/div[6]/div[2]/div[2]/div[5]").click()
time.sleep(6)
